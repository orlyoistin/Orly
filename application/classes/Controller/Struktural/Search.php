...
class Controller_Struktural_Search extends Controller_Struktural_Backend {
	...
	function action_klasifikasi(){
		...
		$view = View::factory('struktural/klasifikasi_search')
	...
	function action_skpd(){
		...
		$view = View::factory('struktural/skpd_search')
			->bind('results', $results)
			->bind('page_links', $page_links)
			->bind('no', $no)
			->bind('url',$url)
