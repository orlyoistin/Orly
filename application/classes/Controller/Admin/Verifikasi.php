...
class Controller_Admin_Verifikasi extends Controller_Admin_Backend {
	...
	function action_index(){
		...
		$this->template->content = View::factory('admin/verifikasi')
			->set('results', $results)
	...
	public function action_edit() {
		...
		$this->template->content = View::factory('admin/verifikasi_form')
			->bind('form',$form)
			->set('id',$id)
			->set('url',URL::base().'admin/verifikasi/update/'.$id)
	...
	public function action_update() {	
		...
		try {
			...
			HTTP::redirect(URL::base().'admin/verifikasi');
		}
		catch (ORM_Validation_Exception $e) {
			$errors = $e->errors('models');		
			
			$this->template->content = View::factory('admin/surat_form')
				->bind('form',$form)
				->set('id',$id)
				->set('url',URL::base().'admin/surat/update/'.$id)
				->set('submit_value','Update Data')
				->set('template_list',$this->getList('Template','name','Pilih Template'))
				->set('parent_list',Model::factory('Custom')->parent());	
		}
