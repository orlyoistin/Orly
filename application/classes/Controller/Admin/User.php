...
class Controller_Admin_User extends Controller_Admin_Backend {
	...
	public function action_new() {
		$jabatan_list = $this->getList('Jabatan','name','');
			
		if(Auth::instance()->get_user()->jabatan_id == 2) {
			$jabatan_list = $this->getList('Jabatan','name','',array(array('id','>=',2)));
		}
		
		$this->template->content = View::factory('admin/user_form')
			->bind('errors',$error)
			->set('form',$this->getField('User'))										
			->set('url',URL::base().'admin/user/create')
			->set('submit_value',"Tambah Data")
			->set('jabatan_list',$jabatan_list)
	...
	public function action_edit() {
		...
		$this->template->content = View::factory('admin/user_form')
			->bind('errors',$errors)
			->set('form',$form)
			->set('url',URL::base().'admin/user/update/'.$id)
	...
	public function action_password() {
		...
		$view = View::factory('admin/password_form')
			->bind('errors',$errors);
			
		$view->form 		= $form;
		$view->url 			= URL::base().'admin/user/update_password';
	...
	public function action_search() {
		...
		echo View::factory('admin/user_search')
			->set('url',URL::base().'admin/user')										
	...
	public function action_data() {
		...
		foreach($users as $user) {
			$arrData[] = array(
				$i + $_REQUEST['start'],
				"<a id='".$user->id."' href='".URL::base()."admin/user/edit/".$user->id."'>".$user->username."</a>",
				$user->name,
