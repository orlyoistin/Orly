...
class Controller_Dinas_Verifikasi extends Controller_Dinas_Backend {
	...
	function action_index(){
		...
		$this->template->content = View::factory('dinas/verifikasi')
			->set('results', $results)
	...
	public function action_edit() {
		...
		$this->template->content = View::factory('dinas/verifikasi_form')
			->bind('form',$form)
			->set('id',$id)
	...
	public function action_update() {	
		...
		try {
			...
			$this->template->content = View::factory('dinas/surat_form')
				->bind('form',$form)
				->set('id',$id)
