...
class Controller_Dinas_Sotk extends Controller_Dinas_Backend {
	...
	function action_index(){	
		...
		$this->template->content = View::factory('dinas/sotk')
			->set('skpd_id',$skpd_id);
	}
	...
	public function action_new() {
		...
		echo View::factory('dinas/sotk_form')
    		->set('form',$this->getField("Sotk"))
    		->set('url',URL::base().'dinas/sotk/save')										
	...
	public function action_edit() {
		...
		echo View::factory('dinas/sotk_form')
			->bind('form',$form)
			->set('id',$id)
			->set('url',URL::base().'dinas/sotk/update/'.$id)
	...
	function action_data() {
		...
		foreach($xsotk as $var) {
			if($var) {
				...
				$arrData[] = array(
					$i + $_REQUEST['start'],
					"<a id='".$sotk->id."' data-fancybox data-type='ajax' data-src='".URL::base()."dinas/sotk/edit/".$sotk->id."'>".$prefix.$sotk->name."</a><br>".$prefix.$sotk->pejabat."<br>".$prefix.$sotk->nip 
				);
				$i++;
			}
		}
