...
class Controller_Dinas_Template extends Controller_Dinas_Backend {
	...
	function action_index(){							
		...
		$this->template->content = View::factory('dinas/template')
			->set('results', $results)
			->set('page_links', $pagination->render('pagination/diggs'))
			->set('i', $pagination->offset+1)
			->set('url',URL::base().'dinas/template')
	...
	public function action_new() {
		...
		echo View::factory('dinas/template_form')
			->set('form',$this->getField("template"))
			->set('url',URL::base().'dinas/template/save')										
	...
	public function action_edit() {
		...
		echo View::factory('dinas/template_form')
			->bind('form',$form)
			->set('id',$id)
			->set('url',URL::base().'dinas/template/update/'.$id)
	...
	public function action_save() {	
		try {
			...
			HTTP::redirect(URL::base().'dinas/template');			
		}
		catch (ORM_Validation_Exception $e) {
			$errors = $e->errors('models');			
			$this->template->content = View::factory('dinas/template_form')
				->bind('errors', $errors)
				->set('form', $_POST)
				->set('url',URL::base().'dinas/template/save')
				->set('submit_value','Tambah Data');
	...
	public function action_search() {
		...
		echo View::factory('dinas/template_search')
			->set('url',URL::base().'dinas/template');										
	}
}
?>