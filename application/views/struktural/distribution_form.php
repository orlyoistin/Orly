...
echo Form::open($url, array('class'=>'savedata','table_id'=>'note_table'));
...
<table width="100%" class="table">
    ...
    <tr>
      ...
      <td valign="top" bgcolor="#FFFFFF"><?php echo Form::select('kepada',$sotk_list,Arr::get($form, 'kepada'),array('id'=>'kepada')); 
                    if(isset($errors['kepada'])) {
                        echo " <img src='".URL::base()."assets/images/error12.gif'>";
                    }?></td>
    </tr>
    <tr>
