...
$(function() {
	...
	$('#klasifikasi_id').on('change', function() {
		...
		$.ajax({
			type		: "POST",
			cache		: false,
			url			: '<? echo URL::base()."admin/inaktif/retensi"; ?>',
  ...
  <div class="box-body">
    <div class="box-header">
      ...
      <table width="100%" class="table">
          <tr>
            <td width="19%" align="right" valign="baseline"><strong>Bulan / Tahun</strong></td>
            <td width="81%" valign="baseline"><?php echo Form::select('bulan',$bulan_list,Arr::get($form, 'bulan'))." ".Form::input('tahun',Arr::get($form, 'tahun'),array('id'=>'tahun','size'=>'5')); 
                        if(isset($error['tanggal'])) {
                            echo " <img src='".URL::base()."assets/images/error12.gif'>";
                        }?></td>
          </tr>
          <tr>
            <td align="right" valign="baseline"><strong>Kode Pelaksana</strong></td>
            <td valign="baseline">
          ...
          <tr>
            <td align="right" valign="baseline"><strong>Hasil</strong></td>
            <td valign="baseline"><?php echo Form::input('hasil',Arr::get($form, 'hasil')); 
          ...
          <tr>
            ...
            <td valign="baseline">Tahun Aktif : <? echo Form::input('ra',Arr::get($form, 'ra'),array('id' => 'ra','size'=>'1','readonly'=>'')); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Tahun Inaktif : <? echo Form::input('ri',Arr::get($form, 'ri'),array('id' => 'ri','size'=>'1','readonly'=>'')); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tahun : <? echo Form::input('ti',Arr::get($form, 'ti'),array('id' => 'ti','size'=>'2','readonly'=>'')); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Retensi JRA :&nbsp;<?php echo Form::select('keterangan_id',$keterangan_list,Arr::get($form, 'keterangan_id'),array('id'=>'k')); 
                            ?></td>
          </tr>
          <tr>
            <td align="right" valign="baseline"><strong>Isi Informasi</strong></td>
            <td valign="baseline"><?php echo Form::textarea('isi',Arr::get($form, 'isi'),array('id' => 'isi','rows'=>'3','cols'=>'60'));
                        if(isset($error['isi'])) {
                            echo " <img src='".URL::base()."assets/images/error12.gif'>";
                        }?></td>
          </tr>
          <tr>
            ...
            <td align="left" valign="baseline"><?php echo Form::select('guna_id',$guna_list,Arr::get($form, 'guna_id')); 
          ...
          <tr>
            ...
            <td align="left" valign="baseline"><?php echo Form::select('media_id',$media_list,Arr::get($form, 'media_id')); 
          ...
          <tr>
            ...
            <td align="left" valign="baseline"><?php echo Form::select('tingkat_id',$tingkat_list,Arr::get($form, 'tingkat_id')); 
                            if(isset($error['tingkat_id'])) {
                                echo " <img src='".URL::base()."assets/images/error12.gif'>";
                            }?></td>
          </tr>
          <tr>
            <td align="right" valign="baseline"><strong>Jumlah</strong></td>
            <td align="left" valign="baseline"><?php echo Form::input('jumlah',Arr::get($form, 'jumlah'),array('size'=>'5')); ?><? echo Form::select('lampiran_id',$lampiran_list,Arr::get($form, 'lampiran_id')); ?></td>
          </tr>
          <tr>
