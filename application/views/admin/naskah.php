...
$(document).ready(function() {
    table = $("#naskah_table").DataTable({
		...
		"processing": true,
		"ajax":{
			url :"<? echo URL::base()."admin/naskah/data"; ?>",
			type: "post"
		},
		"aoColumnDefs": [
      ...
      <table width="100%" class="table table-striped table-bordered" id="naskah_table">
          <thead>
            <tr>
                ...
                <th width="33%" align="left">Perihal</th>
                <th width="10%" align="center" class="text-center">Jenis</th>
                <th width="18%" align="left">Posisi Terakhir</th>
                <th width="9%" align="center" class="text-center">Status</th>
            </tr>
          </thead>
	  </table>
      <a class="btn btn-warning" href="<? echo URL::base().'dinas/naskah/new'; ?>">Tambah Data</a>
	</div>
</div>
<?
echo Form::close()
