...
<script>
$(function() {
	$("#skpd_id").jCombo("<? echo URL::base(); ?>admin/base/skpd", {selected_value: '<? echo Arr::get($form, 'skpd_id'); ?>'});
	$("#sotk_id").jCombo("<? echo URL::base(); ?>admin/base/sotk/?id=", {parent:"#skpd_id",selected_value: '<? echo Arr::get($form, 'sotk_id'); ?>'});
