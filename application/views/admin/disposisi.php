...
<div class="box box-solid box-info">        
    ...
    <div class="box-body">
        <table width="100%" class="table table-striped table-bordered">
          ...
          <tr>
                <td valign="baseline">
                <a data-fancybox data-type="ajax" data-src="<? echo URL::base()."admin/distribution/new/".$masuk->id; ?>">
          ...
          <table width="100%" class="table table-striped table-bordered">
            <thead>
              <tr>
                ...
                <th width="28%" align="left">Diteruskan Kepada</th>
            ...
            foreach($disposisis as $disposisi) {
                $xtgl = explode("-",$disposisi->tanggal);
                $tgl = $xtgl[2]."-".$xtgl[1]."-".$xtgl[0];
                ?>
                <tr bgcolor="#F3F3F3">
                  <td align="center"><? echo $i; ?></td>
                  <td align="center"><? echo $tgl; ?></td>
                  <td align="left"><? echo $disposisi->dari; ?></td>
                  <td align="left"><? echo $disposisi->kepada; ?></td>
            ...
            <tr bgcolor="#F3F3F3">
              <td height="30" colspan="6">
              	<div class="btn-right">
                <a target="_blank" class="btn btn-danger pull-right" href="<? echo URL::base()."admin/disposisi/cetak/".$masuk->id; ?>">Cetak</a>
                </div></td>
            </tr>
          </table>
        </div>
