...
<table width="100%" cellspacing="0" cellpadding="5">
    ...
    foreach($results as $surat) {
        ...
        <tr>
            ...
            <td align="left"><? echo $surat->klasifikasi->name; ?></td>
            <td align="left"><? echo $surat->klasifikasi->kode; ?><br /><? echo $surat->isi; ?></td>
          ...
          <td align="center"><? echo $surat->ra; ?></td>
            ...
            <td align="center"><? echo $surat->guna->name; ?></td>
            <td align="center"><? echo $surat->tingkat->name; ?></td>
