...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<? echo URL::base(); ?>assets/template/logo/logo.png">

    <title>SIKD Kutai Barat</title>

    <!-- Bootstrap core CSS -->
    <link href="<? echo URL::base(); ?>assets/template/css/bootstrap.min.css" rel="stylesheet">
    <link href="<? echo URL::base(); ?>assets/template/css/new.css" rel="stylesheet">
    <link href="<? echo URL::base(); ?>assets/template/css/animate.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css" rel="stylesheet">
    <script src="<? echo URL::base(); ?>assets/template/js/jquery.min.js"></script>
    <script src="<? echo URL::base(); ?>assets/template/js/bootstrap.min.js"></script>
    <script src="<? echo URL::base(); ?>assets/template/js/wow.min.js"></script>
    <script src="<? echo URL::base(); ?>assets/template/js/smooth-scroll.js"></script>
    <script>
      new WOW().init();
      smoothScroll.init();
    </script>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"><img class="img-responsive" src="<? echo URL::base(); ?>assets/template/logo/logo.png"></a>
        </div>
      ...
      <div class="container marketing">
        <div class="row">
          ...
          <div class="col-sm-4 col-md-4 animate-box wow bounceInLeft animated">
            <div class="thumbnail">
              <img src="<? echo URL::base(); ?>assets/template/logo/logo.png" alt="...">
              <div class="caption">
