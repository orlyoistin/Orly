...
<div class="table_title">INBOX</div>
<div id="reload">
<div class="table">
	<table width="100%" class="table table-striped table-bordered table-condensed">
		...
		<tr>
		  	...
		  	<th width="11%" align="center" bgcolor="#D6D6D6" class="text-center">Nomor Surat</th>
		  	<th width="20%" align="left" bgcolor="#D6D6D6">Dari</th>
		  	<th width="21%" align="left" bgcolor="#D6D6D6">Perihal</th>
		  	<th width="18%" align="left" bgcolor="#D6D6D6">Kepada</th>
		  	<th width="19%" align="left" bgcolor="#D6D6D6">Tembusan</th>
	  	  </tr>
		</thead>
        <tbody>
		<?
		foreach($results as $surat) {
			...
			<tr>
				...
				<td align="center"><? echo "<a data-fancybox data-type='ajax' data-src='".URL::base()."dinas/surat/view/".$surat->id."'>".$surat->nomor."</a>"; ?></td>
				<td align="left"><? echo $surat->source->name."</a>"; ?></td>
        ...
        <tr>
            <td colspan="8"><? if($num_rows==0) {echo "<span class='na'>Note : Data tidak ditemukan</span>";} else {echo $page_links;} ?></td>
        </tr>
	</table>
</div>
</div>
