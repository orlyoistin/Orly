          ...
          <table width="100%" class="table table-striped table-bordered">
            ...
            foreach($distributions as $distribution) {
				if($distribution->masterbool_id == 1) {
					$b = "<a class='push btn btn-warning btn-xs' href='".URL::base().'admin/base/push/'.$distribution->id."'><i class='fa fa-clock-o'></i></a>";
				}
				else {
            ...
            ?>
            <tr>
              <td height="30" colspan="7"><a data-fancybox data-type="ajax" class="btn btn-primary pull-right" data-src="<? echo URL::base()."dinas/distribution/new/".$masuk->id; ?>">Tambah Distribusi</a></td>
            </tr>
          </table>
    	</div>
    </div>
