...
$(function() {
	...
	$("select#kepada").select2({
		width: "75%",
		placeholder: "Pilih jika Tujuan adalah SKPD",
		allowClear: true,
	});
    ...
    <div class="box-body">
        <table width="100%" class="table">
            ...
            <tr>
              ...
              <td valign="middle"><?php echo Form::input('tanggal_surat',Arr::get($form, 'tanggal_surat'),array('id'=>'tanggal_surat','size'=>'10')); 
            ...
            <tr>
              ...
              <td valign="middle"><?php echo Form::input('tanggal',Arr::get($form, 'tanggal'),array('id'=>'tanggal','size'=>'10')); 
