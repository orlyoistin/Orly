...
<table width="100%" class="table table-striped table-bordered">
    ...
    <tr>
        ...
        <div class="btn-right">
        <a data-fancybox data-type="ajax" class="btn btn-primary pull-right" data-src="<? echo URL::base().'admin/user/new'; ?>">Tambah Data</a>
        <a data-fancybox data-type="ajax" class="btn btn-danger pull-right" data-src="<? echo URL::base()."admin/user/search"; ?>">Cari Data</a>
