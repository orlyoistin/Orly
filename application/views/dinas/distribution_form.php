...
<table width="100%" class="table">
    <tr>
      ...
      <td width="86%" valign="top" bgcolor="#FFFFFF"><?php echo Form::input('tanggal',Arr::get($form, 'tanggal'),array('id'=>'tanggal','size'=>'10','autocomplete'=>'off')); 
