                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-right">
                      ...
                      <a data-fancybox data-type="ajax" data-src="<? echo URL::base()."admin/user/password"; ?>" class="btn btn-default btn-flat">Change Password</a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <aside class="main-sidebar">
        <section class="sidebar">
          <ul class="sidebar-menu">
            ...
            <li><a href="<? echo URL::base()."admin"; ?>"><i class="fa fa-home"></i> <span>Home</span></a></li>
            <li><a href="<? echo URL::base()."admin/masuk"; ?>"><i class="fa fa-inbox"></i> <span>Surat Masuk</span></a></li>
            <li><a href="<? echo URL::base()."admin/keluar"; ?>"><i class="fa fa-send-o"></i> <span>Surat Keluar</span></a></li>            
            <!--li><a href="<? //echo URL::base()."admin/berkas"; ?>"><i class="fa fa-file-archive-o"></i> <span>Pemberkasan</span></a></li!-->
            <li><a href="<? echo URL::base()."admin/inaktif"; ?>"><i class="fa fa-archive"></i> <span>Arsip Inaktif</span></a></li>
            <li><a href="<? echo URL::base()."admin/naskah"; ?>"><i class="fa fa-file-text-o"></i> <span>Naskah Dinas</span></a></li>
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<? echo URL::base()."admin/skpd"; ?>"><i class="fa fa-institution"></i> OPD</a></li>                
                <? 
				if(Auth::instance()->get_user()->jabatan_id == 1) {
					?>
                    <li><a href="<? echo URL::base()."admin/template"; ?>"><i class="fa fa-file-code-o"></i> Template Naskah</a></li>
                	<li><a href="<? echo URL::base()."admin/klasifikasi"; ?>"><i class="fa fa-tags"></i> Klasifikasi</a></li>
                    <?
				}
				?>
                
                <li><a href="<? echo URL::base()."admin/user"; ?>"><i class="fa fa-user"></i> User</a></li>
              </ul>
            </li>  
          </ul>          
        </section>
